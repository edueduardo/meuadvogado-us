        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex items-center space-x-6">
              ...
              <Link href="/advogado/academy" className="text-gray-600 hover:text-indigo-600 transition flex items-center gap-1">
                <span>🎓</span> Academy
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Academy Promo */}
            <div className="bg-white rounded-2xl shadow-xl p-6 overflow-hidden relative group cursor-pointer hover:shadow-2xl transition">
              <Link href="/advogado/academy">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">🎓 Academy</h3>
                <p className="text-sm text-gray-600 mb-4 pr-8">
                  Aprenda a triplicar suas vendas com nossos tutoriais exclusivos.
                </p>
